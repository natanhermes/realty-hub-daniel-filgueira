  ...
  return (
    <nav className="flex justify-between items-center py-4 mx-2 md:mx-10">
      ...
      <div className="items-center gap-1 hidden lg:flex text-black ">
        <Link href={'/#sobre-imobiliaria'}>
          <Button variant={'link'} className="text-base px-1">Sobre a imobiliária</Button>
        </Link>
        <Link href={'/#sobre-daniel-filgueira'}>
          <Button variant={'link'} className="text-base px-1">Sobre Daniel Filgueira</Button>
        </Link>
        <Button variant={'link'} className="text-base px-1" onClick={() => window.open(`https://wa.me/558496703029?text=Olá! Estou vindo do site. Sou corretor e gostaria de mais informações.`, '_blank')}>Sou corretor</Button>
        <Button variant="link" className='text-base px-1' onClick={() => window.open(`https://wa.me/558496703029?text=Olá! Estou vindo do site e gostaria de cadastrar meu imóvel.`, '_blank')}>
          Quero cadastrar meu imóvel
        </Button>
      </div>
    </nav>
