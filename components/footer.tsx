...
import meuIA from "@/app/assets/meu-ia-logo.jpg";
import googleSecurity from "@/app/assets/google-security.png";
import logoSSL from "@/app/assets/logo-ssl.png";

export function Footer() {
  return (
    <footer className="pt-10 bg-darkBlue flex flex-col">
      <div className="p-10 bg-darkBlue flex flex-col gap-6 md:flex-row justify-between items-center">
        <div className="flex flex-col items-center gap-6">
          <p className="text-whiteIce font-bombalurina text-7xl font-medium">Daniel Filgueira</p>
          <p className="text-white text-center text-xs">
            © 2025 Meu.IA. Todos os direitos reservados.
          </p>
        </div>

        <div className="hidden md:flex md:flex-col md:items-end gap-6">
          <h3 className="text-white text-xs md:text-lg">Siga nossas redes sociais</h3>
          <div className="flex gap-2">
            <Link href="https://www.instagram.com/meu_ia/" target="_blank">
      ...
      <div className="w-full flex justify-center items-center bg-opacity-60 bg-[#110e41] p-8">
        <div className="flex items-center gap-2">
          <p className="text-white text-sm">Desenvolvido por</p>
          <Link href="https://www.instagram.com/meu_ia/" target="_blank"><Image src={meuIA} alt="Logotipo" className="w-12 rounded-full" /></Link>
        </div>
      </div>
    </footer>
  );
